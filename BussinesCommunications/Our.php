      ...
      <div class="container-fluid body col-lg-12 g-0">
        ...
        <div class="row g-0 px-0 py-0">
          <div class="col-12" style="border-right: 1px dotted white;">
            ...
            <div class="row g-0 px-0 py-0">
              <h2 style="text-align:center; color:#5e5b5b;">Наши контакты</h2>
              <p class="Myp">Московское региональное управление: Оператор - 8 999 999 99 99</p>
              <p class="Myp">Администратор - 8 999 999 99 98</p>
            </div>
          </div>
        </div>
      </div>
