      ...
      <div class="container-fluid body col-lg-12 g-0">
        ...
        <div class="row g-0 px-0 py-0">
          <div class="col-12" style="border-right: 1px dotted white;">
            <h1 style="text-align:center; color:#5e5b5b;">Наши принципы</h1>
            <div class="row g-0 px-0 py-0">
              <h2 style="text-align:center;">Принципиальные стимулы</h2>
              <p class="Myp">В нашей организации работа по совести вознаграждается.</p>
            </div>
          </div>
        </div>
      </div>
